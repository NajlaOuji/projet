...
@foreach ($users as $user)
@if($user->id === $projet->id_chef)
<td class="chef">{{$user->name}}</td>
@endif
@endforeach
<td class="datedeb">{{$projet->date_debut}}</td>
<td class="datefin">{{$projet->date_fin}}</td>
<td class="etat">{{$projet->etat}}</td>
<td class="taux">{{$projet->taux_avancement}}</td>
<td class="text-center">

<a class="btn btn-success projetUpdate" href="#" data-toggle="modal" data-id="'.$projet->id.'" data-target="#updateProjet"><span class="fa fa-pencil"></span></a> 
<a class="btn btn-danger" href="{{ url('delete_projet/'.$projet->id,$projet->titre_projet) }}" onclick="return confirm('Are you sure want to delete it?')"><span class="fa fa-trash"></span></a>
...
<div class="modal" id="module">
 ...
 <!-- Modal update projet-->
 <div class="modal" id="updateProjet">
  <div class="modal-dialog">
    <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('updateProjet') }}" method = "post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="idprojet" id="idprojet" value="" />
                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Titre Projet</label>
                                        <div class="col-sm-8">
                                        <input class="form-control" name="titre" id="titre_p"  />
                                            </div>
                    </div>

                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Client</label>
                                        <div class="col-sm-8">
                                        <select class="form-control" id="client_p" name="client">
                                                          @foreach ($users as $user)
                    ...
                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Document </label>
                                        <div class="col-sm-8">
                                        <input type="file" name="file" id="document_p" >
                                        <input type="hidden" name="hidden_file" id="e_file" value="{{ $projet->document }}" >
                                        </div>
                    </div>

                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Chef projet</label>
                                        <div class="col-sm-8">
                                        <select class="form-control" id="chef_p" name="chef">
                                        @foreach ($users as $user)
                    ...
                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Date Début De Projet</label>
                                        <div class="col-sm-8">
                                        <div class="input-group">
                    ...
                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-3 bn col-form-label">Date Fin De Projet</label>
                                        <div class="col-sm-8">
                                        <div class="input-group">
 ...
 <!-- End Modal update-->
       ...
       <script src={{asset('admin/plugins/datatables/jquery.dataTables.min.js')}}></script>
        ...
        <script>
  $(document).on('click','.projetUpdate',function()
        {
            var _this = $(this).parents('tr');

            $('#idprojet').val(_this.find('.idprojet').text());
            $('#titre_p').val(_this.find('.titre').text());
            $('#e_file').val(_this.find('.document').text());
           
            $('#date1').val(_this.find('.datedeb').text());
            $('#date2').val(_this.find('.datefin').text());
            
            $('#demo1').val(_this.find('.taux').text());
            $('#client_p').val(_this.find('.client').text());
            $('#chef_p').val(_this.find('.chef').text());
