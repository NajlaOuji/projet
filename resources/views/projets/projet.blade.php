...
<a class="btn btn-danger" href="{{ url('delete_projet/'.$projet->id.$projet->id_chef) }}" onclick="return confirm('Are you sure want to delete it?')"><span class="fa fa-trash"></span></a>
